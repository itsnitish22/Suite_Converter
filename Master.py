...
if __name__ == "__main__":
    ...
    while (1):
        ...
        if 'first' in query: 
            ...
            call(["python", "B.py"])    #Calling file for text to mp3
            
        elif 'third' in query:
            call(["python", "C.py"])    #Calling file for images inter-conversion
            
        elif 'fourth' in query:
            call(["python", "D.py"])    #Calling file for multiple images to pdf
            
        elif 'fifth' in query or '5' in query:
            call(["python", "E.py"])    #Calling file for pdf to multiple images
           
        elif 'sixth' in query or 'six' in query:
            call(["python", "F.py"])    #Calling file for pdf to docx
           
        elif 'seventh' in query:
            call(["python", "G.py"])    #Calling file for mp3 to text
